...
| **GenAI / RAG** | NVIDIA NIM API (`meta/llama-3.1-8b-instruct`) · TF-IDF + cosine similarity retrieval over a 29-chunk compliance knowledge base (CIS, MCSB, ISO 27001, DPDP, HIPAA) |
